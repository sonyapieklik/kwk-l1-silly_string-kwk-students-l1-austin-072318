...
bigger_word = big_word.insert(0,"wow mom") # Use String concatenation to add "wow" and "mom" to big_word
...
sentence = sentence.gsub(/[AO]/, 'A' => a, 'O' => o ) # Add your gsub chain here
